...
@RestController
@RequestMapping("/casa_editrice_manga")
public class CasaEditriceMangaController {

    @Autowired
    CasaEditriceMangaService service;
    ...
    @GetMapping
    public ResponseEntity<List<CasaEditriceManga>> findAll() {
